    ...
    return (      
      <div>
        <div className="w-full pt-6 md:p-8 text-center md:text-left space-y-2">
          <header className="text-red-300 w-max text-5xl m-auto font-extrabold text-center uppercase">
        ...
        <form>             
          <div className="flex flex-col items-center m-2">
            <div className="m-2 w-min ">
              <label htmlFor="username" className="text-green-300 font-extrabold">
                Insert Username:
              </label>        
              <input
                className=""
